...
public class EventRegistrationDbContext :
    AbpDbContext<EventRegistrationDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(EventRegistrationConsts.DbTablePrefix + "YourEntities", EventRegistrationConsts.DbSchema);
